 ...
 */
;(function() {
  var Timer = require('../../../../famous/src/utilities/Timer');
  ...
  function runInContext(context) {
    ...
    function debounce(func, wait, options) {
      ...
      function delayed() {
        ...
        if (remaining <= 0 || remaining > wait) {
          ...
          timeoutId = Timer.setTimeout(delayed, remaining);
        }
      }
      ...
      function debounced() {
        ...
        if (maxWait === false) {
          ...
          if (isCalled) {
            ...
            maxTimeoutId = Timer.setTimeout(maxDelayed, remaining);
          }
        }
        if (isCalled && timeoutId) {
          ...
          timeoutId = Timer.setTimeout(delayed, wait);
        }
        if (leadingCall) {
          isCalled = true;
          result = func.apply(thisArg, args);
    ...
    function defer(func) {
      ...
      var args = arguments;
      return Timer.setTimeout(function() { func.apply(undefined, slice(args, 1)); }, 1);
    }
    ...
    function delay(func, wait) {
      ...
      var args = arguments;
      return Timer.setTimeout(function() { func.apply(undefined, slice(args, 2)); }, wait);
    }
